---
layout: single
title: Aplicación ahorcado con thunkable.
excerpt: "En este artículo vamos a poder conocer como desarrollar una aplicación como es la del juego del ahorcado, de una manera facil y sencilla, con la que podemos seguir avanzando en el campo de la programación. Para ello, la aplicación debe contar con 2 jugadores, donde uno introduce la palabra secreta y el otro adivinarla.
A contnuación explicare los pasos a seguir para empezar el desarrollo básico, que despues se puedo completar si lo deseamos."
date: 2021-10-13
classes: wide
header:
  teaser: /assets/images/thunkable-ahorcado/logo.png
